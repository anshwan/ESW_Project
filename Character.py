...
class Stars:
    def __init__(self, width, height):
        ...
        self.appearance = self.stand.resize((100,100))
        #self.position = np.array([width/2 - 20, height/2 - 20, width/2 + 20, height/2 + 20])
        self.position_x = width // 2 - self.appearance.width/2
        self.position_y = height // 2 - self.appearance.height/2 + 90
        self.state = None
    ...
    def draw_star(self, draw):
        draw.bitmap((self.position_x, self.position_y), self.appearance, fill=(125,255,255,255))
